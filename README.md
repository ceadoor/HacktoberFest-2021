...
<body>
  ...
  <h5>By: John Doe</h5>
  <p>
    This algorithm uses bases addition operator to add two numbers
  </p>
  
  <ol>
    <li>Start</li>
    <li>Declare variables num1, num2 and sum</li>
    <li>Read values for num1, num2.</li>
    <li>Add num1 and num2 and assign the result to a variable sum.</li>
    <li>Display sum</li>
    <li>Stop</li>
  </ol>
</body>
